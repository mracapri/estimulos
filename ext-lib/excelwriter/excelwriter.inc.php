<?php
	...
	// ////////////////////////////////////////////////////////////////////
	// FORMAS PARA INSERTAR LINEAS EN EL DOCUMENTO EXCEL
	...
	// forma 2
	//$myArr=array("columna1","columna2","columna3","columna4");
	...
	Class ExcelWriter
	{
		...
		*/
		function open($file)
		{
			...
			{
				$this->error="Error : Another file is opened .Close it to save the file";
				return false;
			}	
