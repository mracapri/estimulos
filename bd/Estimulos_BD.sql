...
--
-- Servidor: localhost
-- Tiempo de generación: 27-06-2012 a las 11:08:28
...
--
-- Estructura de tabla para la tabla `asignacion_indicador`
--
...
--
-- Volcar la base de datos para la tabla `asignacion_indicador`
--
...
--
-- Volcar la base de datos para la tabla `categoria_indicador`
--
...
--
-- Estructura de tabla para la tabla `evaluacion_indicador`
--
...
--
-- Volcar la base de datos para la tabla `evaluacion_indicador`
--
...
--
-- Volcar la base de datos para la tabla `evaluador`
--
...
--
-- Volcar la base de datos para la tabla `modificaciones`
--
...
--
-- Estructura de tabla para la tabla `porcentaje_indicador`
--
...
--
-- Volcar la base de datos para la tabla `porcentaje_indicador`
--

INSERT INTO `porcentaje_indicador` (`id_porcentajeindicador`, `id_categoriaindicador`, `porcentaje`, `descripción`, `anio`) VALUES
(1, 1, 3, NULL, NULL),
(2, 2, 2, NULL, NULL),
(3, 3, 2, NULL, NULL),
(4, 4, 2, NULL, NULL),
...
--
-- Filtros para la tabla `asignacion_indicador`
--
...
--
-- Filtros para la tabla `categoria_indicador`
--
...
--
-- Filtros para la tabla `evaluacion_indicador`
--
...
--
-- Filtros para la tabla `porcentaje_indicador`
--
