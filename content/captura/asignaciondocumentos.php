		...
		<div id="captura-indicadores" class="container">
			...
			<div class="span6 seccion1">
				...
				<div class="span2 seccion1-2" id="documentos-asignados">
					...
					<div class="row-fluid">
						...
						<div class="span3"></div>
					<div class="span2">
						<button class="btn btn-danger" id="quitar-documento" <?php  if(obtenerEstadoDeLaCaptura() == 1){ echo "disabled"; } ?> >Remover</button>
			</div>
			</div>
			...
			<div class="span6 seccion2">
				...
				<div class="row-fluid">
					...
					<div class="span3"></div>	
					<div class="span1">
						<button class="btn btn-primary" id="agregar-documento" <?php  if(obtenerEstadoDeLaCaptura() == 1){ echo "disabled"; } ?>>Agregar</button>
					</div>
				</div>
			</div>
			<div class="row-fluid">
				...
				<div class="span4"></div>
					<form id="form-guardar-asignacion" method="post">
						<button id="guardar-cambios-asignacion" class="btn btn-primary" type="button" <?php  if(obtenerEstadoDeLaCaptura() == 1){ echo "disabled"; } ?> >Guardar Cambios</button>
